# AGENTS.md — The Warded Ones RPG 1

This file teaches future Codex sessions how to work safely in this repository.

> **`CLAUDE.md` is the authoritative, most up-to-date changelog** — check its
> "Current State" section first; this file mirrors the same guidance but may lag.
...
docs/               ← The playable game (GitHub Pages source)
  ...
  game.js           ← Complete game engine (~4700 lines)
...
## Current State (v0.2 — after loop 4)
